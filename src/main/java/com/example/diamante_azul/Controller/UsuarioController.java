...
public class UsuarioController {
    ...
    public String actualizarUsuario(@PathVariable Integer id, @ModelAttribute Usuario usuario) {
        // Nota: Para una actualización segura, primero podrías cargar el usuario existente
        // para evitar que se anulen campos no incluidos en el formulario.

        // 1. Aseguramos que el ID del path se use en el objeto Usuario
        usuario.setId(id);

        // 2. Guardamos (Spring Data JPA es inteligente y sabe si es nuevo o update)
