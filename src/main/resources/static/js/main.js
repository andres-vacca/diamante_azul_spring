...
function checkLocalAuthStatus() {
    // Verificar si hay elementos que indican autenticación
    const authElements = document.querySelectorAll('[data-authenticated="true"]');
...
function handleGlobalError(event) {
    ...
    // Comentado para evitar alertas molestas en cada error menor
...
async function performLogout() {
    ...
    try {
        // Simular logout (en producción sería una llamada AJAX real)
