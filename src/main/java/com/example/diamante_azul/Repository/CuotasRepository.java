...
public interface CuotasRepository extends JpaRepository<Cuotas, Long> {
    ...
    // 1. Buscar todas las cuotas de un Usuario específico
    // Spring traduce esto a: SELECT * FROM cuotas WHERE usuario_id = ?
    List<Cuotas> findByUsuarioCliente_Id(Integer usuarioId);
